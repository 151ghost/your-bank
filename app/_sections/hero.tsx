...
function TransactionCard() {
  return (
    <FadeInElement
      asChild
      className="relative w-full max-md:h-[368px] flex flex-col 2xl:gap-[26px] gap-5 2xl:p-[34px] md:p-[27px] p-5 rounded-[8px] bg-[url(/assets/transaction-bg.png)] bg-black"
    >
